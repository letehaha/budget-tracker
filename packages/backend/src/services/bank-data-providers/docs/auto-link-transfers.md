...
flowchart TD
    ...
    other synced account, opposite type,
...
- Different accounts, same user. Both accounts are bank-synced: manual (`system`) accounts and Walutomat accounts never participate.
