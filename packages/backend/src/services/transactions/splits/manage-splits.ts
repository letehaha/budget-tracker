...
import type { CreateSplitPayload } from '@models/transaction-splits.model';
import TransactionSplits, { bulkCreateSplits, deleteSplitsForTransaction } from '@models/transaction-splits.model';
