...
export const getCombinedBalanceHistory = async ({
  ...
  try {
    ...
    // Run the accounts/vehicles/loans split as three filtered aggregations. All hit
    ...
    // Combine accounts, vehicles, portfolio, venture, and loan balances with O(1) lookups
