...
// Budget Bakers Wallet's `create-new` variant carries `currencyCode` + `currentBalance`,
// which makes it a different shape from the CSV importer's `accountMappingValueSchema`
