      ...
      <div class="mb-4 mt-2">
        ...
        >
          ...
          <ChevronDownIcon
            ...
            :class="{ 'rotate-180': showModelHint }"
          />
        </button>
        <p
          v-if="showModelHint"
          class="bg-muted/50 text-muted-foreground mt-2 rounded-md p-2 text-xs"
        >
          For transaction categorization, <strong>low-cost models</strong> like Gemini Flash,
          Claude Haiku, or GPT-4o Mini are recommended. Categorization is a straightforward task
          that doesn't require expensive reasoning models. Using cheaper models lets you process
    ...
    <template #after-card>
      ...
      <div class="mt-4 border-t pt-4">
        ...
        <ul class="text-muted-foreground list-disc space-y-1.5 pl-5 text-xs leading-relaxed">
          <li>
            When you sync transactions from your bank, uncategorized transactions are automatically
            sent to AI for categorization.
          </li>
          <li>
            The AI analyzes transaction descriptions and merchant names to suggest appropriate
            categories from your existing category list.
          </li>
...
import { AI_FEATURE, AIFeatureStatus } from '@bt/shared/types';
...
const { availableModels, groupedModels, isLoading: isLoadingModels } = useFeatureModels(
