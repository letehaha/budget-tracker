...
export const CHART_TOOLTIP_SURFACE_CLASS =
  'bg-card-tooltip text-card-tooltip-foreground border-card-tooltip-border rounded-xl border px-3.5 py-2.5 text-sm shadow-xl supports-[backdrop-filter]:bg-card-tooltip-glass supports-[backdrop-filter]:backdrop-blur-xl supports-[backdrop-filter]:backdrop-saturate-150';
