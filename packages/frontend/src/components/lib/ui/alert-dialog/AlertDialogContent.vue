...
<template>
  <AlertDialogPortal>
    ...
    <AlertDialogContent
      ...
      :class="
        cn(
          'border-border bg-dialog data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-(--z-dialog) grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] grid-cols-1 gap-4 border p-6 shadow-lg duration-200 sm:rounded-lg md:w-full',
          props.class,
        )
      "
    >
